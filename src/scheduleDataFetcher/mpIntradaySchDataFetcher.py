...
def getMpIntradaySchData(targetFilePath: str, unitDetailsDf: pd.DataFrame(), targetDt: dt.datetime) -> List[IMpIntradaySchDataRecord]:
    """_summary_
    Args:
    ...
    """
    mpIntradaySchRecords: List[IMpIntradaySchDataRecord] = []
